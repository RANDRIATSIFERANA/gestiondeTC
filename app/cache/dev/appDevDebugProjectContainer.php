...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c50_1' => 'get9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c501Service',
            'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_1' => 'getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef411Service',
            'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_2' => 'getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef412Service',
            'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_3' => 'getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef413Service',
    ...
    /**
     * Gets the '9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c50_1' service.
     *
     ...
     */
    protected function get9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c501Service()
    {
        return $this->services['9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c50_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the 'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef411Service()
    {
        return $this->services['a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef412Service()
    {
        return $this->services['a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef413Service()
    {
        return $this->services['a27c38881fcb60cd7efcfc1aaed4ab1403ae65ca418be97b8f25c018e821ef41_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/gestiondeTC/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/gestiondeTC/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/gestiondeTC/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/gestiondeTC/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_119c5c301c3250a8fd2eb26eeae2d658ae17757937f6173895c2d95c6d397f61');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_119c5c301c3250a8fd2eb26eeae2d658ae17757937f6173895c2d95c6d397f61');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_119c5c301c3250a8fd2eb26eeae2d658ae17757937f6173895c2d95c6d397f61');
        ...
        $d->setProxyDir('C:/wamp/www/gestiondeTC/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/gestiondeTC/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('9256604a1eadd11e883e4829c784ae0099e297594311532aefd87af97be23c50_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/gestiondeTC/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/gestiondeTC/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/gestiondeTC/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/gestiondeTC/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/gestiondeTC/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/gestiondeTC/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/gestiondeTC/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/gestiondeTC/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/gestiondeTC/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/gestiondeTC/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/gestiondeTC/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/gestiondeTC/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\gestiondeTC\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/gestiondeTC/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/gestiondeTC/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/gestiondeTC/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/gestiondeTC/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/gestiondeTC/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/gestiondeTC/app/logs',
            ...
            'debug.container.dump' => 'C:/wamp/www/gestiondeTC/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/gestiondeTC/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/gestiondeTC/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/gestiondeTC/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/gestiondeTC/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/gestiondeTC/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/gestiondeTC/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/gestiondeTC/app/../web',
            'assetic.write_to' => 'C:/wamp/www/gestiondeTC/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/gestiondeTC/app/cache/dev/doctrine/orm/Proxies',
